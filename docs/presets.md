...
| **HEPATOVIRUS**       | HEPATOVIRUS, HEPATITIS_A, HEPATITIS_A_VIRUS, HAV | Alignment-filtering optimized for Hepatovirus A. Includes specialized alignment-filtering settings for improved genome recovery to compensate for sequencing artifacts in Picornaviridae sequencing data.<br>Currently only tailored for Hepatovirus A. |
