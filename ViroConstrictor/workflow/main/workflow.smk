...
from ViroConstrictor.workflow.helpers.generic_workflow_methods import (
    create_samples_df, # used in construction of samples_df
...
from ViroConstrictor.workflow.helpers.presets import get_binary, get_flags
...
samples_df = create_samples_df(SAMPLES)
