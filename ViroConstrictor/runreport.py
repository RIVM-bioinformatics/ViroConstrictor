...
def WriteReport(workingdir, inpath, startpath, conf, sparams, sconfig, status):
    ...
    directories = {
        0: ['Output directory:', 'This is the directory where the output files were written as well as this summary.', "\t\t\t\t" + workingdir], 
        1: ['Input directory:', 'This is the directory that was given containing the input files.', "\t\t\t\t" + inpath],
        2: ['Starting point:', 'This is the directory where the pipeline was started from.', "\t\t\t\t" + startpath]
        }
