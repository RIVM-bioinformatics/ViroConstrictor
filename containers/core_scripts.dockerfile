...
COPY ./ViroConstrictor/workflow/envs/core_scripts.yaml /install.yml

LABEL org.opencontainers.image.description="Supplementary scripts for the ViroConstrictor core workflow."
