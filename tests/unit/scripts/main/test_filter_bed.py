...
@pytest.mark.xfail(reason="Current script uses AssertionError for invalid path types; intended behavior is explicit ValueError with actionable message", strict=False)
